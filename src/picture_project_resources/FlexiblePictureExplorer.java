...
import card_game_resources.Coordinate;
...
public abstract class FlexiblePictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  private void createAndInitPictureFrame()
  {
    ...
    pictureFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // when close stop
  ...
  {
	  mouseDragging = true;
	  mouseDraggedAction(picture, new Pixel(picture,e.getX(), e.getY()));
	  mouseDragging = false;
  }
  ...
  public abstract void mouseDraggedAction(DigitalPicture pict, Pixel pix) ;
  
  public abstract void mouseUpdateAction(boolean down, Pixel pix) ;
  ...
  public void mouseClicked(MouseEvent e)
  {
	...
	mouseDragging = false;
    mouseClickedAction(picture, new Pixel(picture,e.getX(), e.getY()));
  }
  ...
  {
	  mouseUpdateAction(true, new Pixel(picture,e.getX(), e.getY()));
	//mouseClickedAction(picture, new Pixel(picture,e.getX(), e.getY()));
    //displayPixelInformation(e);
  }
  ...
  {
	  mouseDragging = false;
	  mouseUpdateAction(false, new Pixel(picture,e.getX(), e.getY()));
  }
  ...
  public void setCursorImage() {
	...
	pictureFrame.getContentPane().setCursor(blankCursor);
  }
